...
CREATE TABLE `users` (  `account_id` int(11) NOT NULL AUTO_INCREMENT,  `user_name` varchar(25) NOT NULL,  `first_name` varchar(25) DEFAULT NULL,  `last_name` varchar(30) DEFAULT NULL,  `email_address` varchar(60) DEFAULT NULL,  PRIMARY KEY (`account_id`)) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
...
INSERT INTO `users` VALUES (1,'testAccount','Test','Account','asommer@madisoncollege.edu'),(2,'secondAccount','My','Name','test@test.com');
