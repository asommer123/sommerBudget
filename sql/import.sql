...
CREATE TABLE `budgetMonth` (
  ...
  CONSTRAINT `budgetMonth_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `users` (`account_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `budgetedSubCategory` (
  ...
  `envelope_amount` decimal(7,2) DEFAULT NULL,
  `note` text,
  `subCategory_id` int(11) NOT NULL,
  `budget_month_id` int(11) NOT NULL,
  PRIMARY KEY (`budgeted_id`),
  KEY `fk_subCategory` (`subCategory_id`),
  KEY `fk_budetMonth` (`budget_month_id`),
  CONSTRAINT `budgetedSubCategory_ibfk_1` FOREIGN KEY (`subCategory_id`) REFERENCES `subCategory` (`subCategory_id`),
  CONSTRAINT `budgetedSubCategory_ibfk_2` FOREIGN KEY (`budget_month_id`) REFERENCES `budgetMonth` (`budget_month_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `category` (
  ...
  `default_fl` tinyint(1) DEFAULT NULL,
  `account_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`),
  KEY `fk_account` (`account_id`),
  CONSTRAINT `category_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `users` (`account_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `income` (
  ...
  KEY `fk_budgetMonth` (`budget_month_id`),
  CONSTRAINT `income_ibfk_1` FOREIGN KEY (`budget_month_id`) REFERENCES `budgetMonth` (`budget_month_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `subCategory` (
  ...
  `default_fl` tinyint(1) DEFAULT NULL,
  `day_of_month_due` int(2) DEFAULT NULL,
...
CREATE TABLE `transaction` (
  ...
  `transaction_amount` decimal(7,2) DEFAULT NULL,
